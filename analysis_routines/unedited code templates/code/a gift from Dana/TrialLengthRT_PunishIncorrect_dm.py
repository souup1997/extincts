...
datafolder = "R:/Projects/Dana/Dana_StarWars_2023_Dups/training_data/punish_incorrect/"
#"G:/Shared drives/Grissom Lab UMN/Projects/Dana/Dana_StarWars_2023_Dups/training_data/punish_incorrect/"
...
for day in dayList:
    ...
    for filename in fileList:
        ...
        print(mouseID + ": " + train_raw.scheduleID.unique()[0])
    ...
    df.to_csv(os.path.join(datafolder,day  + "_allAnimals_PunishIncorrect.csv"),index=False)
...
for day in dayList: 
    dayDF = pd.read_csv(os.path.join(datafolder,day  + "_allAnimals_PunishIncorrect.csv"))
    for val in ['initiation reaction time', 'choice reaction time', 'retrieval reaction time', 'trial_dur']:
        ...
        dayDF.to_csv(os.path.join(datafolder,day  + "_allAnimals_PunishIncorrect.csv"),index=False)
...
sumDF.to_csv(os.path.join(datafolder,"punishIncorrect_summaryDF.csv"), index=False)
